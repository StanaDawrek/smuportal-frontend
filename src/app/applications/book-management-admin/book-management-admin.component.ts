...
@Component({
  selector: 'app-book-management-admin',
  templateUrl: './book-management-admin.component.html',
  styleUrls: ['./book-management-admin.component.css']
})
@Input()
export class BookManagementAdminComponent implements OnInit {
